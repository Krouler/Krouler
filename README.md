...
<br>
<p>Также ознакомлен с Django и внутренним окружением проекта на Django, включая все связи. Постепенно пишется пет-проект. Ознакомлен со всеми функциями Django, включая DRF.</p>
<h2>ЯП C#</h2>
...
<h2>Ищу работу в сфере разработки на Python(Django, ML, DS, Data analyst) или C#(Backend, gamedev, на java тоже)<br>Diversity.ReSize.Increase(1)</h2>
